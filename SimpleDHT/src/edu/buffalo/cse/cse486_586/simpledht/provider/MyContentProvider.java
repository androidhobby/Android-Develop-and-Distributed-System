...
public class MyContentProvider extends ContentProvider {
	...
	public static final String TABLE_NAME = "Distributed_Hash_Table";
	...
	public static final class MyContent implements BaseColumns {
		...
		public static final Uri CONTENT_URI = Uri.parse("content://edu.buffalo.cse.cse486_586.simpledht.provider" + "/myProvider");
	}
	
	private static final HashMap<String, String> dhtMap;
	static {
		dhtMap = new HashMap<String, String>();
		dhtMap.put(MyContent.ID, MyContent.ID);
		dhtMap.put(MyContent.KEY, MyContent.KEY);
		dhtMap.put(MyContent.VALUE, MyContent.VALUE);
	}
